        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="/buku" class="menu-link">
              <div data-i18n="Lihat Semua Buku">Lihat Semua Buku</div>
            </a>
          </li>
          @if (Auth::user()->isAdmin == 1)
            <li class="menu-item">
              <a href="/buku/create" class="menu-link">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="/anggota" class="menu-link">
              <div data-i18n="Lihat Semua anggota">Lihat Semua anggota</div>
            </a>
          </li>
          @if (Auth::user()->isAdmin == 1)
            <li class="menu-item">
              <a href="/anggota/create" class="menu-link">
                <div data-i18n="Tambah anggota">Tambah Pengguna</div>
              </a>
            </li>
          @endif
        </ul>
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="/peminjaman" class="menu-link">
              <div data-i18n="Lihat Semua Peminjaman">Lihat Semua Peminjaman</div>
            </a>
          </li>
          @if (Auth::user()->isAdmin == 1)
            <li class="menu-item">
              <a href="/peminjaman/create" class="menu-link">
          ...
          <ul class="menu-sub">
            <li class="menu-item">
              <a href="/admin" class="menu-link">
                <div data-i18n="Lihat Semua Admin">Lihat Semua Admin</div>
              </a>
            </li>
            <li class="menu-item">
