                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="text-sm text-dark h5 mb-0 font-weight-dark">{{ $buku }}</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="button mt-2"><a href="/anggota" class="text-dark">Lihat</a></div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card h-100 bg-danger">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-sm text-dark font-weight-bold text-uppercase mb-1" style="font-size:.8`rem;">Riwayat Peminjamam</div>
                            <div class="h5 mb-0 mr-3 font-weight-bold text-dark">{{ $jumlah_riwayat }}</div>
                            <div class="button mt-2"><a href="#" class="text-dark">Lihat</a></div>
                        </div>
                        <div class="col-auto">
